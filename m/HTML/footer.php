...
<footer>
	<div class="footer-row1">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 col-md-5 mt-3 mt-lg-0 mt-md-0">
					<h5 class="text-white">Subscribe To Our Newsletter</h5>
					<div class="email-subs-form">
						<form class="row" name="subscribe_form" id="subscribe_form" method="post">
							<div class="col-lg-10 col-8">
								<input type="email" placeholder="Enter Email ID" name="email" id="email">
							</div>
							<div class="col-lg-2 ps-0 col-4">
								<button type="submit" id="subscribe_submit" class="lnk btn-main bg-btn">Submit <span class="circle"></span></button>
							</div>
						</form>
	...
	<div class="footer-row2">
		<div class="container">
			<div class="row justify-content-between">
				<div class="col-lg-4 col-sm-6  ftr-brand-pp">
					<a class="navbar-brand  mb25 f-dark-logo" href="#"> <img src="images/logo.svg" alt="MDRC"/></a>
					<a class="navbar-brand mt30 mb25 f-white-logo" href="#"> <img src="images/logo.svg" alt="MDRC" /></a>
					<p>Modern Diagnostic & Research Centre Pvt. Ltd. Is one of India’s Fastest growing Diagnostic chain having more than 1800+ collection point across India and a network of 15 Labs across 7 states.</p>
				</div>
				<div class="col-lg-2 col-sm-6">
					...
					<ul class="footer-address-list link-hover">
                        ...
                        <li><a href="#" data-bs-toggle="modal" data-bs-target="#modalform-full">Home Sample Collection</a></li>
		...
		<!-- Start city -->
		<?php if(count($this->rs_footer_popular_test)>0){?>
			<div class="row">
				<div class="col-lg-12 mt80 col-sm-12">
					<h6 class="fw-semibold mb20">Popular Tests</h6>
					<?php for($i=0;$i<count($this->rs_footer_popular_test);$i++){?>
					<a class="tags" href="tests/<?=$this->rs_footer_popular_test[$i]['slug']?>/<?=$_SESSION['citySlug'];?>"><?=$this->rs_footer_popular_test[$i]['name']?></a>
                    <?php }?>
				</div>
			</div>
            <?php }?>
		...
		<?php if(count($this->rs_gs_city)>0){?>
			<div class="row">
				<div class="col-lg-12 mt40 col-sm-12">
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="footer-">
							<p>©2023 All right reserved. Modern Diagnostic & Research Centre Pvt. Ltd.</p>
						</div>
					</div>
				</div>
			</div>
                      ...
                      <div class="col-md-6 form-group">
                        <div class="row align-items-center no-gutters">
                          ...
                          <div class="col-lg-6 col-md-7 mt-2 mt-lg-0 mt-md-0 mb-2 mb-lg-0 mb-md-0">
                      		<label class="text-dark ms-0 me-2"><input type="radio" value="Male" id="gender_male" name="gender"/> Male</label>
      ...
      <div class="modal-content">
        <div class="modal-body">
	        <div class="col-md-12 text-center w-100 pb-2">
	          	...
	          	<h5 class="pt-5">Select City</h5>
	        </div>
         	<div class="form-block fdgn2 mt0 mb10">
	            <form action="" method="post" name="feedback-form">
	              <div class="fieldsets row m-auto">
	                	<div class="col-md-12 ps-4 pe-4 mt-3 mb-0 space_coupon position-relative">
	        ...
	        <div class="row m-auto">
	          	<div class="col-md-12 cities-ul text-center pt-2 pb-2">
	          			<ul class="sCity">
                        	<?php for($i=0;$i<count($this->rs_gs_city);$i++){
						  ...
						  <ul class="cityListWithoutImage">
                        	<?php for($i=0;$i<count($this->rs_gs_city);$i++){
								...
								$cityimage = $this->utility->get_image_path($cityimage, 'city', 'large');
								?>
	          					<li><a class="<?=$activeClass?>" href="javascript:void(0)" onclick="changeCity(<?=$cityId?>)"><span><?=$cityName?></span></a></li>
                                <?php }}?>
	          			</ul>
	          	</div>
	        </div>
