...
// New Added Function 2021 BY Rahul
	...
	function get_image_path($image_name,$folder,$type)
	{
			...
			if($image_name!="" && file_exists(IMAGE_ABS_PATH."/uploads/".$folder."/".$image_name))
			{
				$large_image= IMAGE_SERVER_ROOT."/uploads/".$folder."/".$image_name;
				$medium_image= IMAGE_SERVER_ROOT."/uploads/".$folder."/".'mediumthumb'.$image_name;
				$thumb_image= IMAGE_SERVER_ROOT."/uploads/".$folder."/".'thumb'.$image_name;
			}
			else
			{
				if($folder=='customer')
				{
					$large_image=IMAGE_SERVER_ROOT.'/uploads/default_customer.png';
					$medium_image=IMAGE_SERVER_ROOT.'/uploads/default_customer.png';
					$thumb_image=IMAGE_SERVER_ROOT.'/uploads/default_customer.png';
				}
				else
				{
					$large_image=IMAGE_SERVER_ROOT.'/uploads/default.png';
					$medium_image=IMAGE_SERVER_ROOT.'/uploads/default.png';
					$thumb_image=IMAGE_SERVER_ROOT.'/uploads/default.png';
				}
			}
			if($type=='')
			{
