...
<section class="msite-footer-payment main-wrap pb-3 pt-3 bg-white">
    <div class="row g-3 align-items-stretch">
        <div class="col-12">
...
<section class="msite-footer-bottom-space main-wrap pb-3 pt-3">
    <div class="row g-3 align-items-stretch">
      <div class="col-12">
        ©2024 All right reserved. Modern Diagnostic & Research Centre Limited.
      </div>
    </div>
</section>
...
<footer class="footer-wrap">
     ...
     <a href="<?=M_SERVER_ROOT;?>/mdrc-test-booking-enquiry" class="btn btn-solid w-100 mb-1 pb-3  btn-sty2"><span>Enter your 10 digit mobile number for call back</span></a>
     <ul class="footer">
        ...
        <li class="footer-item">
            <a href="<?=M_SERVER_ROOT;?>/radiology/imaging-lab-tests-near/<?=$_SESSION['citySlug'];?>" class="footer-link">
        ...
        <li class="footer-item">
            ...
            <a href="<?=M_SERVER_ROOT;?>/my-account" class="footer-link"><img src="assets/images/mdrc/icons/profile.svg" alt=""><span>Profile</span></a>
            <?php } else {?>
            <a href="javascript:void(0)" class="footer-link loginModal"><img src="assets/images/mdrc/icons/profile.svg" alt=""><span>Profile</span></a>
            <?php } ?>
        </li>
    </ul>
        </div>
    <ul class="footer d-none">
        <li class="footer-item active">
...
<?php 
$class='';
if(in_array($this->getCurrentView(),$pages)) { 
    $class='page-fixed';
}
?>
<div class="whatsapp-sticky <?=$class;?>">
