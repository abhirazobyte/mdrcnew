...
for($i=0;$i<count($city);$i++)
{
	...
	$xmlString.='
<url><loc>'.$url.'radiology/imaging-lab-tests-near/'.$citySlug.'</loc><priority>0.9</priority><changefreq>weekly</changefreq></url>
	';
...
//Save XML as a file
$dom->save('../../sitemap/radiology-imaging-sitemap.xml');
?>