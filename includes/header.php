						...
						<button class="searSubmit" type="submit"><img src="images/icon-red-search.png" alt="" /></button>
							...
							<div class="collapse navbar-collapse" id="mynavbar">
								<ul class="navbar-nav ml-auto">
									<li class="nav-item"><a href="<?= SERVER_ROOT; ?>" class="nav-link head-menu">
											<i class="fas fa-home"></i>
										</a></li>
									<!-- new link -->
									<li class="nav-item dropdown">
										<a href="#" class="nav-link dropdown-toggle head-menu">About Us</a>
										<ul class="dropdown-menu main-menu" aria-labelledby="navbarDropdown">
											...
											<li class="nav-item dropdown">
												<div class="d-flex">
													<a href="for-doctors/modern-lab" class="nav-link ps-3 pe-2">Lab Services</a>
												</div>
											</li>
											<li class="nav-item dropdown">
												<div class="d-flex">
													<a href="for-doctors/modern-imaging" class="nav-link ps-3 pe-2">Imaging Services</a>
												</div>
											</li>
											...
											<li class="nav-item dropdown">
												<a class="nav-link dropdown-toggle">Investor Relation</a>
												<ul class="dropdown-menu sub-menu" aria-labelledby="navbarDropdown">
													<li class="nav-item dropdown">
													...
													<li class="nav-item dropdown">
														<a class="dropdown-item" href="news-releases">News Releases</a>
													</li>
												</ul>
											</li>
										</ul>
									...
									<li class="nav-item dropdown mob-viewmega">
										<a class="nav-link dropdown-toggle head-menu" href="radiology/imaging-lab-tests-near/<?= $_SESSION['citySlug']; ?>" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
									...
									<li class="nav-item dropdown mob-viewmega">
										<a class="nav-link dropdown-toggle head-menu" href="for-patients" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
											Radiology Scan
										</a>
										<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
									...
									<li class="nav-item dropdown  position-static des-viewmega">
										<a class="nav-link dropdown-toggle-cust head-menu" href="pathology/lab-blood-test-near/<?= $_SESSION['citySlug']; ?>" aria-expanded="false">Book Your Blood Test </a>
									...
									<li class="nav-item dropdown  position-static des-viewmega">
										<a class="nav-link dropdown-toggle-cust head-menu" href="radiology/imaging-lab-tests-near/<?= $_SESSION['citySlug']; ?>" id="navbarDropdown" aria-expanded="false">
											Radiology Scan
										</a>
										<div class="dropdown-menu w-100 mt-0 p-0" aria-labelledby="navbarDropdown">
											<div style="" class="">
									...
									<li class="nav-item dropdown">
										<a class="nav-link dropdown-toggle head-menu" href="reach-us" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
											Contact Us
										</a>
										<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
