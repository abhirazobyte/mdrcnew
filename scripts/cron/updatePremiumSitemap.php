...
for($i=0;$i<count($city);$i++)
{
	...
	$xmlString.='
<url><loc>'.$url.'premium-health-checkup/'.$citySlug.'</loc><priority>0.9</priority><changefreq>weekly</changefreq></url>
	';
...
//Save XML as a file
$dom->save('../../premium-full-body-healthcheckup-sitemap.xml');
?>